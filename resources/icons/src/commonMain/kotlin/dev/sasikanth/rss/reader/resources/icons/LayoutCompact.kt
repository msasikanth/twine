...
val TwineIcons.LayoutCompact: ImageVector
  get() {
    if (layoutCompact != null) {
      ...
      Builder(
        ...
        .apply {
          path(
            ...
            moveTo(10.0f, 3.0f)
            lineTo(23.0f, 3.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 24.0f, 4.0f)
            lineTo(24.0f, 4.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 23.0f, 5.0f)
            lineTo(10.0f, 5.0f)
          ...
          path(
            ...
            moveTo(10.0f, 15.0f)
            lineTo(23.0f, 15.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 24.0f, 16.0f)
            lineTo(24.0f, 16.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 23.0f, 17.0f)
            lineTo(10.0f, 17.0f)
...
private var layoutCompact: ImageVector? = null
