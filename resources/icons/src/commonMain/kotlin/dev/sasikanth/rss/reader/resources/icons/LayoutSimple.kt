...
val TwineIcons.LayoutSimple: ImageVector
  get() {
    if (layoutSimple != null) {
      return layoutSimple!!
    }
    layoutSimple =
      Builder(
        ...
        .apply {
          path(
            ...
            lineTo(1.0f, 4.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 2.0f, 3.0f)
            close()
          }
          path(
            fill = SolidColor(Color(0xFF1A1C15)),
          ...
          path(
            ...
            lineTo(16.5f, 9.0f)
            arcTo(1.5f, 1.5f, 0.0f, false, true, 15.0f, 7.5f)
            lineTo(15.0f, 4.5f)
          ...
          path(
            ...
            lineTo(2.0f, 21.0f)
            arcTo(1.0f, 1.0f, 0.0f, false, true, 1.0f, 20.0f)
            lineTo(1.0f, 20.0f)
          ...
          path(
            ...
            moveTo(16.5f, 15.0f)
            lineTo(21.5f, 15.0f)
            arcTo(1.5f, 1.5f, 0.0f, false, true, 23.0f, 16.5f)
            lineTo(23.0f, 19.5f)
            arcTo(1.5f, 1.5f, 0.0f, false, true, 21.5f, 21.0f)
            lineTo(16.5f, 21.0f)
            arcTo(1.5f, 1.5f, 0.0f, false, true, 15.0f, 19.5f)
            lineTo(15.0f, 16.5f)
...
private var layoutSimple: ImageVector? = null
