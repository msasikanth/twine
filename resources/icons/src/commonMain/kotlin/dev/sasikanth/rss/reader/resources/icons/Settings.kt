...
public val TwineIcons.Settings: ImageVector
  get() {
    if (_settings != null) {
      return _settings!!
    }
        ...
        .apply {
          group(translationX = -0.0f, translationY = 960.0f) {
            path(
              ...
              reflectiveQuadTo(533.0f, -694.0f)
              lineToRelative(-13.0f, -106.0f)
              horizontalLineToRelative(-79.0f)
              lineToRelative(-14.0f, 106.0f)
              quadToRelative(-31.0f, 8.0f, -57.5f, 23.5f)
              reflectiveQuadTo(321.0f, -633.0f)
              lineToRelative(-99.0f, -41.0f)
              lineToRelative(-39.0f, 68.0f)
              ...
              lineToRelative(99.0f, -42.0f)
              quadToRelative(22.0f, 23.0f, 48.5f, 38.5f)
              reflectiveQuadTo(427.0f, -266.0f)
              lineToRelative(13.0f, 106.0f)
              close()
              moveToRelative(42.0f, -180.0f)
