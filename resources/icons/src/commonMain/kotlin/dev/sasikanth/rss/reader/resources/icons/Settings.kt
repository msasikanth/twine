    ...
    _Settings =
      ImageVector.Builder(
        ...
        .apply {
          ...
          path(fill = SolidColor(Color(0xFF514347)), pathFillType = PathFillType.EvenOdd) {
            moveTo(7.706f, 16.683f)
            curveTo(7.799f, 17.435f, 8.437f, 18f, 9.195f, 18f)
            horizontalLineTo(10.8f)
            curveTo(11.552f, 18f, 12.189f, 17.442f, 12.287f, 16.696f)
            ...
            curveTo(15.969f, 10.399f, 15.976f, 10.193f, 15.976f, 10f)
            ...
            curveTo(12.217f, 2.565f, 11.578f, 2f, 10.82f, 2f)
            horizontalLineTo(9.216f)
            curveTo(8.463f, 2f, 7.827f, 2.558f, 7.729f, 3.304f)
            ...
            curveTo(4.047f, 9.586f, 4.039f, 9.792f, 4.039f, 10f)
            ...
            curveTo(5.586f, 10.833f, 5.539f, 10.433f, 5.539f, 10f)
            ...
            curveTo(14.429f, 9.14f, 14.476f, 9.567f, 14.476f, 10f)
...
@Suppress("ObjectPropertyName") private var _Settings: ImageVector? = null
