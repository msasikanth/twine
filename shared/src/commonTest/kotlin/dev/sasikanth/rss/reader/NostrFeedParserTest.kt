...
class NostrFeedParserTest {
  ...
  fun parsingNostrArticlesShouldWorkCorrectly() = runTest {
    val expectedArticles =
      listOf(
        PostPayload(
          ...
          link =
            "nostr:naddr1qqyk6etp943h2mrsvyqs6amnwvaz7tmwdaejumr0dsq3qamnwvaz7tmwdaehgu3wwa5kuegzyqalp33lewf5vdq847t6te0wvnags0gs0mu72kz8938tn24wlfze6qcyqqq823cx48sea",
          description = "",
          rawContent =
        ...
        PostPayload(
          ...
          link =
            "nostr:naddr1qqyrxvm9vvcrjwf4qy8hwumn8ghj7mn0wd68ytnddaksygpm7rrrljungc6q0tuh5hj7ue863q73qlheu4vywtzwhx42a7j9n5psgqqqw4rsxlhq4k",
          description = "",
          rawContent =
    ...
    val parsedArticles =
      listOf(firstNostrArticle, secondNostrArticle).map { json -> NostrFeedParser.parsePost(json) }
